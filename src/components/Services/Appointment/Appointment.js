...
const Appointment = () => {
    ...
    const swalAlert = async () => {
        ...
        const response = await axios.post('https://school-driectory22-c33f9-default-rtdb.firebaseio.com/Appointments/.json', {DoctorsName:docName,Date:value,UserName:user.displayName,UserEmail:user.email,Problem:text});
    ...
    return (
        <Box id='appointment'
            ...
            <Container maxWidth="xl">
             ...
             sx={{ mt: 2, mb: 2 }} fullWidth label="Problem type" id="fullWidth" />
